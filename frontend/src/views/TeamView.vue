  ...
  <div class="team">
    <div class="grid place-items-center space-y-16 px-6">
        ...
        <div class="lg:w-2/5 w-full px-4">
            <p class="text-center text-xl">Mir sinn eng Mini-Entreprise aus dem Lycée classique de Diekirch déi aus 5 ambitionéierten 2e Schüler besteet. Mir hunn dëse Projet am Kader vun de schouleschen Aktivitéiten vun der asbl Jonk Entrepreneuren Lëtzebuerg gegrënnt. Mir hunn eis als Zil gesat, mat eiser Mini-Entreprise den Kanner wéi och den Erwuessenen mat eisen Touren vill Freed ze maachen, d’Rausgoen an d’Natur rëm méi no ze bréngen an hinnen schéin Dierfer oder Stied hei am Land op eng spilleresch an kulinaresch Aart a Weis entdecken loossen.</p>
        </div>
        ...
        <div v-if="isMobile()">
          <div class="lg:flex lg:space-x-6 space-y-16 grid place-items-center">
            ...
            <div class="grid lg:place-items-start lg:w-1/2">
              ...
              <h3 class="text-center text-base font-sans 2xl:w-2/3 w-full pb-6">Administrateur an Organisateur vun der Entreprise</h3>
              <p class="text-center 2xl:w-2/3 w-full text-xl">Ech sinn den Fabian an si bei Foodsteps fir d’Administratioun an d’Organisatioun zoustänneg. Ech verfollegen d’Zil eng Kéier selwer eng Entreprise ze grënnen an ze leeden, dowéinst sinn ech frou Deel vun dësem Projet ze sinn. An menger Fräizäit sinn ech fräiwëllege Pompjee an spillen am Orchester Saxophon an Klarinett.</p>
            </div>
          </div>
        </div>
        <div v-else>
        ...
        <div class="lg:flex lg:space-x-6 space-y-16 grid place-items-center">
          ...
          <div class="grid lg:place-items-start lg:w-1/2">
            ...
            <p class="text-center 2xl:w-2/3 w-full text-xl">Ech sinn de Chef Financier vun eiser Ekipp. Ech këmmere mech also em d’Comptabilitéit an d’Finanz-Situatioun vun eiser Entreprise. Een Hobby ass zum Beispill all Woch meng ganz Suen fir eng nei Hoerfaarf auszeginn, alles aneres wier jo langweileg. Soss sinn ech och déi oppenst Persoun di mer kennen, et kann een mat mir ëmmer iwwer alles schwätzen.</p>
          </div>
        </div>
